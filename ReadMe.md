...
| `checkBoxIcons`            | No      | object (default `{check:image,uncheck:image}`) | This property enables when you `checkBoxType` is `icon`. You can override the default icons of the checkbox by providing the following format value object of local images `checkBoxIcons={{check:`<img width=15 width=15 color='#06C149' title="Check Icon" src="https://github.com/BrokenHeartProgrammer/selected-option-picker/blob/master/src/assets/check.png">`, uncheck:`<img width=15 width=15 color='#06C149' title="Check Icon" src="https://github.com/BrokenHeartProgrammer/selected-option-picker/blob/master/src/assets/uncheck.png">`}}` or remote images `checkBoxIcons={{check: {uri: URL},uncheck: {uri: URL}}}` |
